    ...
    <>
      ...
      <div className={directorStyle.container}>
        <div className={directorStyle.container2}>
          <p className={directorStyle.paragraph}>
            ...
            игры и логические настольные игры. В 2017 году я основала школу
            шахмат и логических игр Stratego.{" "}
          </p>
          <p className={directorStyle.paragraph}>
            ♟️ Думать о том, что ребенок уже слишком взрослый для шахмат —
            неверно. Проверено на собственном опыте 💯.Так, о шахматах я узнала
            в 8 лет. И через три года заняла третье место на детском чемпионате
            Европы в Турции.{" "}
          </p>
          <p className={directorStyle.paragraph}>
            🌼 В шахматах я оказалась по своей инициативе: услышала, что кто-то
            из знакомых детей получил медаль. И мне тоже такую захотелось. В
            семье никто не играл до этого. На первом же занятии тренер заметил
            способности и уговорил родителей, чтобы я продолжала занятия.
          </p>
          <div className={directorStyle.container3}>
          <p className={directorStyle.paragraph}>
          ...
          <p className={directorStyle.paragraph}>
            ...
            👉 Соревнуюсь с друзьями в количестве посещённых стран (сейчас их
            34),
            <br />
            ...
            самых неожиданных местах) ✌️
          </p>
          <p className={directorStyle.paragraph}>
            🔅 Мне очень повезло с тренерами на всем шахматном пути. И когда
            сама стала преподавать, то уже знала, как нужно строить уроки
            максимально комфортно и одновременно продуктивно.
          </p>
          <p className={directorStyle.paragraph}>
            🙋‍♀️ Глядя на довольных детей на занятиях, надеюсь, что мне это
            удается 😊
          </p>
          </div>
        </div>
